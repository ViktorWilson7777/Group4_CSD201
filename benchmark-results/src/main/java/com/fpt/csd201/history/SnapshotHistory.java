...
public class SnapshotHistory implements HistoryStrategy {
    ...
    public boolean undo(TextEditor editor) {
        ...
        // Move operation label to redo side
        if (!operationLabels.isEmpty()) {
            redoOperationLabels.push(operationLabels.pop());
        }
    ...
    public boolean redo(TextEditor editor) {
        ...
        // Move operation label back to undo side
        if (!redoOperationLabels.isEmpty()) {
            operationLabels.push(redoOperationLabels.pop());
        }
    ...
    public Operation peekRedo() {
        return redoOperationLabels.isEmpty() ? null : redoOperationLabels.peek();
    }
    ...
    public List<Operation> getRedoActionHistory() {
        return new ArrayList<>(redoOperationLabels);
    }
}
